...
class TransactionsExport implements WithMultipleSheets
{
    ...
    public function sheets(): array
    {
        ...
        $sheets[] = new TransactionYearSheet($this->year);
        ...
        for ($month = 1; $month <= 12; $month++) {
            $sheets[] = new TransactionMonthSheet($month, $this->year, $monthNames[$month]);
        }
...
// Sheet untuk data setahun
class TransactionYearSheet implements FromCollection, WithHeadings, WithColumnWidths, WithStyles, WithEvents, \Maatwebsite\Excel\Concerns\WithTitle
{
...
// Sheet untuk data per bulan
class TransactionMonthSheet extends TransactionYearSheet
{
    protected $month;
    protected $monthName;

    public function __construct($month, $year, $monthName)
    {
        $this->month = $month;
        $this->year = $year;
