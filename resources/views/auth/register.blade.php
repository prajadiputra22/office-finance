        ...
        <section class="flex flex-col justify-center items-center flex-1 bg-white fade-in">
            <div class="mb-3">
                <h1 class="text-4xl font-bold justify-center">
                    <span class="text-black font-bold">TigaJaya</span>
            ...
            <div class="flex flex-col w-64">
                ...
                <form id="registerForm" method="POST" action="{{ route('admin.register') }}">
                    ...
                    <div class="flex items-center justify-between mt-2 mb-4">
                        <div class="flex items-center">
                            <input type="checkbox" name="terms" id="terms"
                                class="w-5 h-5 mr-2 appearance-none rounded border border-gray-400 checked:bg-[#B6F500] checked:border-[#B6F500] relative">
                    ...
                    <p class="mt-3 text-sm text-center whitespace-nowrap">
                        Sudah punya akun? <a href="{{ route('admin.login') }}" class="text-[#B6F500]">login</a> disini.
                    </p>
                </form>
            </div>
        </section>
