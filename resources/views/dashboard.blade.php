...
<header class="flex justify-end mb-8 animate-fadeIn">
    <h1 class="text-2xl font-bold text-black"> Office <span class="text-[#B6F500]">Finance</span></h1>
</header>
        <section class="mb-8" aria-labelledby="saldo-title">
            <h2 id="saldo-title" class="sr-only">Informasi Saldo</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <article class="flex-1 bg-white border border-[#e5e7eb] p-6 rounded-xl shadow hover:shadow-md transition-shadow duration-200">
                ...
                <article class="flex-1 bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow duration-200">
        ...
        <section class="bg-white border border-[#e5e7eb] p-6 rounded-xl shadow mt-8" aria-labelledby="transaksi-title">
            ...
            <ul class="divide-y divide-gray-200">
                ...
                @empty
                 <li class="py-3 px-5 text-gray-500">Belum ada transaksi</li>
                @endforelse
            </ul>
        </section>
    </main>
