...
@section('content')
        <section class="mb-6 md:mb-8" aria-labelledby="saldo-title">
            <div class="flex items-center justify-between mb-3 md:mb-5">
                <h2 id="saldo-title" class="text-xl md:text-2xl font-bold text-gray-800">Informasi Keuangan</h2>
            </div>
                ...
                <div class="md:hidden space-y-3 mb-8">
                    <div x-data="{open:false}" x-cloak class="bg-white rounded-lg border border-gray-200 shadow-sm">
                        ...
                        <ul x-show="open" x-transition class="border-t border-gray-200">
                            ...
                            <li>
                                <a href="{{ route('category.income', ['type' => 'income', 'category_id' => $category->id]) }}" 
                    ...
                    <div x-data="{open:false}" x-cloak class="bg-white rounded-lg border border-gray-200 shadow-sm">
                        ...
                        <ul x-show="open" x-transition class="border-t border-gray-200">
                            ...
                            <li>
                                <a href="{{ route('category.expenditure', ['type' => 'expenditure', 'category_id' => $category->id]) }}" 
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($recentTransactions as $transaction)
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td
                                        class="px-4 md:px-6 py-3 md:py-4 whitespace-nowrap text-xs md:text-sm font-medium text-center
