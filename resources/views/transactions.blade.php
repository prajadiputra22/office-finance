                ...
                <div x-data="{
                    ...
                    <div class="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-x"
                        ...
                        <table
                                ...
                                <tr>
                                    ...
                                    <th class="p-4 font-semibold text-[#333] text-center relative">
                                        <div class="inline-block">
                                            <label for="filterDate" class="text-sm font-medium text-gray-600">Tanggal
                                                Transaksi</label>
                            ...
                            {{-- Isi Tabel Transaksi --}}
                            <tbody x-data="{ hasVisible: false }" x-init="$watch('selectedDate', () => { hasVisible = false; })">
                                ...
                                @forelse ($transactions as $trx)
                                    <tr class="border-b border-[#e1e5e9] hover:bg-[#f8f9fa]"
                                        ...
                                        <td class="p-4 text-left">{{ \Carbon\Carbon::parse($trx->date)->format('d/m/Y') }}
                                        </td>
