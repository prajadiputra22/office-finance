...
@section('content')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
        <div class="bg-white rounded-lg shadow-md p-4 md:p-6">
            <h3 class="text-lg md:text-xl text-center font-semibold text-[#F20E0F] mb-4">Transaksi Tahun {{ $year }}
            </h3>
    ...
    @push('scripts')
        ...
        <script>
            function filterByCategory(selectedSlug) {
                ...
                window.location.href = `{{ route('category.expenditure', ['slug' => ':slug']) }}`.replace(':slug', selectedSlug) +
                    `?year=${year}`;
            }
